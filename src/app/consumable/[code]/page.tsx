    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white dark:bg-slate-900 rounded-3xl p-8 border border-slate-200 dark:border-slate-800 shadow-xl text-center space-y-4">
          ...
          <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100">ไม่พบข้อมูลวัสดุสิ้นเปลือง</h2>
    ...
    <div className="min-h-screen bg-slate-100/70 dark:bg-slate-950 pb-12">
      ...
      <main className="max-w-2xl mx-auto px-4 pt-4 space-y-4">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-sm space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              {type === 'BOX' && (
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-teal-50 dark:bg-teal-950/50 text-teal-800 dark:text-teal-300 border border-teal-200 dark:border-teal-800 text-xs font-bold">
                  <Box className="w-3.5 h-3.5" />
                  <span>สแกนจากกล่องเวชภัณฑ์ (Stock Box)</span>
                </span>
              )}
              {type === 'PACK' && (
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-50 dark:bg-emerald-950/50 text-emerald-800 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800 text-xs font-bold">
              ...
              {type === 'ITEM' && (
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-purple-50 dark:bg-purple-950/50 text-purple-800 dark:text-purple-300 border border-purple-200 dark:border-purple-800 text-xs font-bold">
          ...
          <div>
            ...
            <div className="font-mono text-xs text-slate-500 dark:text-slate-400 font-bold mt-0.5">
              รหัสพัสดุ: {item.code}
            </div>
          </div>
          ...
          {photoUrl && (
            <div className="w-full h-48 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-850 flex items-center justify-center">
              <img
                src={photoUrl}
                alt={item.name}
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div className="p-3 bg-slate-50 dark:bg-slate-800/80 rounded-xl border border-slate-200/80 dark:border-slate-700">
                  <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 block">รหัสประจำกล่อง</span>
                  <span className="font-mono font-black text-slate-800 dark:text-slate-200 text-xs">{data.boxCode}</span>
                </div>
                <div className="p-3 bg-slate-50 dark:bg-slate-800/80 rounded-xl border border-slate-200/80 dark:border-slate-700">
                  <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 block">เลขอ้างอิง Lot</span>
                  <span className="font-mono font-bold text-teal-800 dark:text-teal-300 text-xs">{data.lot.lotNumber}</span>
                </div>
                <div className="p-3 bg-slate-50 dark:bg-slate-800/80 rounded-xl border border-slate-200/80 dark:border-slate-700">
                  <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 block">วันที่ซื้อ / รับเข้า</span>
                  <span className="font-bold text-slate-800 dark:text-slate-200">
                    {data.lot.receivedDate ? new Date(data.lot.receivedDate).toLocaleDateString('th-TH') : '-'}
                  </span>
                </div>
                <div className="p-3 bg-slate-50 dark:bg-slate-800/80 rounded-xl border border-slate-200/80 dark:border-slate-700">
                  <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 block">วันหมดอายุ (EXP)</span>
              ...
              {/* Location */}
              <div className="p-3 bg-slate-50 dark:bg-slate-800/80 rounded-xl border border-slate-200/80 dark:border-slate-700 flex items-center gap-2 text-xs text-slate-700 dark:text-slate-300">
          ...
          {type === 'PACK' && (
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div className="p-3 bg-slate-50 dark:bg-slate-800/80 rounded-xl border border-slate-200/80 dark:border-slate-700">
                  <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 block">รหัสซองย่อย</span>
                  <span className="font-mono font-black text-teal-900 dark:text-teal-300 text-xs">{data.packCode}</span>
                </div>
                <div className="p-3 bg-slate-50 dark:bg-slate-800/80 rounded-xl border border-slate-200/80 dark:border-slate-700">
                  <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 block">รหัส Sub-lot</span>
                  <span className="font-mono font-bold text-slate-800 dark:text-slate-200 text-xs">{data.repackRecord.subLotNumber}</span>
                </div>
                <div className="p-3 bg-slate-50 dark:bg-slate-800/80 rounded-xl border border-slate-200/80 dark:border-slate-700">
                  <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 block">วันที่แพ็ค/อบฆ่าเชื้อ</span>
                  <span className="font-bold text-slate-800 dark:text-slate-200">
              ...
              <div className="p-3 bg-teal-50/50 dark:bg-teal-950/40 rounded-xl border border-teal-100 dark:border-teal-800 text-xs text-slate-700 dark:text-slate-300 space-y-1">
                ...
                {data.repackRecord.operatorName && (
                  <div className="flex items-center gap-1.5">
                    <User className="w-3.5 h-3.5 text-teal-600 dark:text-teal-400 flex-shrink-0" />
          ...
          {type === 'LOT' && (
            <div className="space-y-3">
              <div className="p-3.5 rounded-2xl bg-teal-50 dark:bg-teal-950/50 border border-teal-200 dark:border-teal-800 text-teal-900 dark:text-teal-200 flex items-center gap-3">
              ...
              {data.lot.nextBox && (
                <div className="p-3 bg-emerald-50 dark:bg-emerald-950/40 rounded-xl border border-emerald-200 dark:border-emerald-800 text-xs text-emerald-900 dark:text-emerald-200 flex items-center gap-2">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div className="p-3 bg-slate-50 dark:bg-slate-800/80 rounded-xl border border-slate-200/80 dark:border-slate-700">
                  <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 block">วันที่รับเข้า</span>
                  <span className="font-bold text-slate-800 dark:text-slate-200">
                    {data.lot.receivedDate ? new Date(data.lot.receivedDate).toLocaleDateString('th-TH') : '-'}
                  </span>
                </div>
                <div className="p-3 bg-slate-50 dark:bg-slate-800/80 rounded-xl border border-slate-200/80 dark:border-slate-700">
                  <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 block">วันหมดอายุ</span>
                  <span className="font-bold text-rose-600 dark:text-rose-400">
                    {data.lot.expiryDate ? new Date(data.lot.expiryDate).toLocaleDateString('th-TH') : 'ไม่ระบุ'}
                  </span>
                </div>
          ...
          {type === 'ITEM' && (
            <div className="space-y-3 text-xs">
              <div className="p-3.5 rounded-2xl bg-teal-50 dark:bg-teal-950/50 border border-teal-200 dark:border-teal-800 text-teal-900 dark:text-teal-200 flex items-center justify-between">
                <div>
                  <span className="text-xs text-teal-700 dark:text-teal-400 font-bold block">ยอดคงเหลือรวมทั้งหมดในคลัง:</span>
                  <span className="text-lg font-black text-teal-900 dark:text-teal-100">{data.item.totalStock} {data.item.unit}</span>
                  {data.item.totalOpenRemainders > 0 && (
                    <span className="ml-2 text-xs font-bold text-purple-700 dark:text-purple-300 bg-purple-100 dark:bg-purple-950/60 px-2 py-0.5 rounded-full">
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-800/80 rounded-xl border border-slate-200/80 dark:border-slate-700 flex items-center gap-2 text-slate-700 dark:text-slate-300">
                <MapPin className="w-4 h-4 text-teal-600 dark:text-teal-400 flex-shrink-0" />
        ...
        <div className="space-y-2.5">
          ...
          <Link
            href="/"
            className="w-full py-3 px-4 rounded-2xl bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 font-bold text-xs border border-slate-200 dark:border-slate-800 shadow-sm transition flex items-center justify-center gap-2 cursor-pointer"
          >
            <ChevronLeft className="w-4 h-4" />
        ...
        {/* Footer info */}
        <div className="text-center text-[10px] text-slate-400 dark:text-slate-500 py-3">
