            ...
            if (task.type === 'PRACTICE_EVENT') {
              ...
              return (
                ...
                >
                  ...
                  <div className="bg-slate-50 dark:bg-slate-850 border-b border-slate-200/80 dark:border-slate-800 p-4 grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
                    ...
                    <div className="space-y-1.5">
                      ...
                      {kitKeys.length === 0 ? (
                        <span className="text-slate-400 dark:text-slate-500 text-xs italic block">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {kitKeys.map((kId) => {
                            ...
                            return (
                              <span
                                key={kId}
                                className="inline-flex items-center gap-1.5 px-3 py-1 rounded-xl bg-white dark:bg-slate-800 border border-indigo-200 dark:border-indigo-800 text-indigo-900 dark:text-indigo-200 font-bold text-xs shadow-sm"
                              >
                    ...
                    <div className="space-y-1.5">
                      ...
                      {task.additionalItems.length === 0 ? (
                        <span className="text-slate-400 dark:text-slate-500 text-xs italic block">ไม่มีอุปกรณ์เสริมเพิ่มเติม</span>
                      ) : (
                        <div className="space-y-1">
                          {task.additionalItems.map((itemStr: string, idx: number) => (
                            <div
                              key={idx}
                              className="text-slate-700 dark:text-amber-200 bg-amber-50/70 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800/80 px-2.5 py-1 rounded-lg text-xs"
                            >
                              • {itemStr}
                            </div>
                          ))}
                        ...
                        {task.students.map((studentBooking: any, idx: number) => {
                          ...
                          return (
                            <div
                              ...
                              className="p-3.5 bg-white dark:bg-slate-900 hover:bg-slate-50/80 dark:hover:bg-slate-800/80 transition flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs"
                            >
                              <div className="flex items-start gap-3">
                                <span className="w-6 h-6 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 font-bold flex items-center justify-center text-[11px] flex-shrink-0 mt-0.5">
                                  {idx + 1}
                                </span>
                                <div className="space-y-1">
                                  <div className="flex items-center gap-2 flex-wrap">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-100 dark:border-slate-800">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {task.status === 'APPROVED' && task.type === 'PRACTICE' && (
                    <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-teal-100 dark:bg-teal-950/50 text-teal-800 dark:text-teal-300 border border-teal-200 dark:border-teal-800">
                  ...
                  {task.status === 'CHECKED_IN' && task.type === 'PRACTICE' && (
                    <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-indigo-100 dark:bg-indigo-950/50 text-indigo-800 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-800 animate-pulse">
                      <Sparkles className="w-3 h-3 text-indigo-600 dark:text-indigo-400" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 bg-slate-50/70 dark:bg-slate-850/80 p-3.5 rounded-xl border border-slate-100 dark:border-slate-800 text-xs">
                ...
                <div className="space-y-1">
                  ...
                  {task.type === 'PRACTICE' ? (
                    <div className="space-y-1">
                      <div className="font-bold text-teal-800 dark:text-teal-300 flex items-center gap-1.5 text-sm">
