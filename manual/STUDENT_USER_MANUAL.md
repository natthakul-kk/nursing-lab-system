...
3. [บทที่ 3: ภาพรวมรายการคำขอและขั้นตอนการยืม-เบิกแบบ One-Stop (ชี้จุดกรอก 1 ถึง 7)](#บทที่-3-ภาพรวมรายการคำขอและขั้นตอนการยืม-เบิกแบบ-one-stop-ภาพจากระบบจริง)
...
## บทที่ 3: ภาพรวมรายการคำขอและขั้นตอนการยืม-เบิกแบบ One-Stop (ภาพจากระบบจริง)

เมื่อนิสิตเข้าสู่เมนู **"ยืม-คืนอุปกรณ์"** ระบบจะแสดงหน้าจอภาพรวม (Overview Dashboard) แสดงประวัติรายการคำขอของนิสิตพร้อมสถานะการดำเนินงานแบบเรียลไทม์ ดังรูปที่ 3.1:

![รูปที่ 3.1 ภาพรวมรายการคำขอยืม-คืนของนิสิตจากระบบจริง](./images/overview_student_dashboard_annotated.png)
*รูปที่ 3.1: ภาพจากระบบจริง - ภาพรวมรายการคำขอยืม-คืนของนิสิต (Overview Dashboard พร้อมข้อมูลคำขอจริงและปุ่ม One-Stop)*
...
เมื่อต้องการสร้างคำขอยืม-เบิกใหม่ ให้กดปุ่ม **"+ ขอยืม-เบิกอุปกรณ์ (One-Stop)"** ที่มุมขวาบนของหน้าจอ ระบบจะเปิดหน้าต่างฟอร์มรวมดังรูปที่ 3.2 ให้นิสิตกรอกข้อมูลตามหมายเลขกำกับในแต่ละช่องดังนี้:

![รูปที่ 3.2 ขั้นตอนการกรอกฟอร์มขอยืม-เบิก One-Stop จากระบบจริง](./images/step_borrow_one_stop_guide.png)
*รูปที่ 3.2: ภาพจากระบบจริง - ชี้ตำแหน่งและสิ่งที่ต้องกรอกในแต่ละช่องอย่างละเอียด (จุดที่ 1 ถึง 7)*
